...
{
	static $default_redirect_uri = 'https://redirect.ixnah.workers.dev';
	...
	function install_1()
	{
		...
		$deepLink = "/quickstart/graphIO?publicClientSupport=false&appName={$appName}&redirectUrl={$redirect_uri}&allowImplicitFlow=false&ru=" . urlencode($ru);
		$app_url = "https://apps.dev.microsoft.com/?deepLink=" . urlencode($deepLink);
		return view::load('install/install_1')->with('title', '系统安装')
			->with('default_redirect_uri', self::$default_redirect_uri) // 默认重定向地址
